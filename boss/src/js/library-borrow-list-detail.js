...
lister({
    ...
    ajaxParam: {
        ...
        param: {
            page: sessionStorage.getItem('listDetailTargetPage') !== null ? sessionStorage.getItem('listDetailTargetPage') : 1,

            // 先这么写，不能这么获取
            bookPlaceId: localStorage.getItem('bookPlaceId'),
            id: urler.normal().id
        },
        title: '书籍详情'
    },
...
pager(function(param, $this) {
    lister({
        ...
        callback: function(data) {
            ...
            sessionStorage.setItem('listDetailTargetPage', targetPage);
        }
    });
});
